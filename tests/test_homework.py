...
def test_search_project(browser):
    ...
    my_project_prefix = generate_random_string(5)
    ...
    project_creating_page = ProjectCreationPage(browser)
    project_creating_page.add_project(my_project_name, my_project_prefix)
